    ...
    <div className="card"  style={{backgroundColor: "whitesmoke", width: "50%", marginLeft: "480px"}}>
       ...
       <div className="card-body">
        <img src={bot.avatar_url} alt={bot.name} />
          ...
          <div className="card-text">
            <span>  
             <i className="bi bi-heart-pulse"style={{color: "red"}} /> Health: {bot.health}
            </span><br></br>
            <span> 
             <i class="bi bi-lightning-fill"  style={{color: "gold"}}/> Damage: {bot.damage}
              {bot.damage}
            </span><br></br>
            <span> 
              <i class="bi bi-shield-shaded" style={{color: "silver"}} /> Armor: {bot.armor}
            </span><br></br>
            <div className="card-text">
